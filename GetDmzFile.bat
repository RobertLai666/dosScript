...
REM ********************
REM Func:GetDmzFile.bat
REM 連線到 DMZ
REM Create:2017/0908/ By Robert Lai V0.10
REM ********************
...
set AppName=GetDmzFile
set StepName01="Add Driver"
set StepName02="Copy File"
set StepName03="Remove Driver"
...
REM tp\account
net use M: \\10.1.11.134\FileServer\FromCIGNA  password /user:tp\LoginID
...
rem call:timeStamp 1 %StepName02%
rem start notepad.exe
rem if %errorlevel% gtr 0 call:ErrorProcess %StepName02%
rem call:timeStamp 2 %StepName02%

rem call:timeStamp 1 %StepName03%
rem net use /delete /y M:
rem if %errorlevel% gtr 0 call:ErrorProcess %StepName03%
rem call:timeStamp 2 %StepName03%
